        ...
        <div class="container-fluid pt-4 px-4">
            <div class="bg-secondary text-center rounded p-4">
                ...
                <div>
                    ...
                    <form action="" >
                        <div class="form-floating mt-3">
                            <textarea wire:click.prevent="redirectLogin"  maxlength="250" class="form-control" placeholder="Leave a comment here" id="floatingTextarea" style="height: 150px;"></textarea>
                            <label for="floatingTextarea">What's Happening?</label>
                        </div>
                        <div class="mb-3 mt-3">
                            <div class="row">
                                <div class="col-lg-auto">
                                    <input wire:click.prevent="redirectLogin" class="form-control  bg-dark" accept="image/*"  type="file">
                                </div>
                                ...
                                <div wire:loading.remove class="col-md-auto">
                                    <button  wire:click.prevent="redirectLogin"" type="button" class="btn btn-md btn-outline-primary">Post</button>
                                </div>
                            </div>
                    ...
                    <div>
                        <form action="">
                            ...
                            <div class="">
                                <div class="row">
                                    <div class="col-lg">
                                        <input wire:click.prevent="redirectLogin" class="form-control  bg-dark" maxlength="250" type="text">
                                    </div>
                                    <div class="col-sm-auto mt-3">
                                        <button wire:click.prevent="redirectLogin" type="button" class="btn btn-outline-primary">Comment</button>
                                    </div>
                                </div>
                            </div>
                        </form>
